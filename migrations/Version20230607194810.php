 ...
 */
final class Version20230607194810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, freelancer_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, subdescription LONGTEXT NOT NULL, category VARCHAR(255) NOT NULL, delevrytime VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, INDEX IDX_E19D9AD28545BDF5 (freelancer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
